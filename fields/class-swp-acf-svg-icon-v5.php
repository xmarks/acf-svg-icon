...
if (!class_exists('swp_acf_field_svg_icon')) {
    class swp_acf_field_svg_icon extends acf_field
    {
        ...
        function render_field_settings($field)
        {
            ...
            $icons_list = $this->svg_files_as_choices($field) ?? [];
            ...
            // Default path in theme
            acf_render_field_setting($field, array(
                'label' => __('Default Path', 'swp-acf-si'),
                'instructions' => __('Enter the path for icons in theme', 'swp-acf-si'),
                'name' => 'default_path',
                'type' => 'text',
                'placeholder' => 'images',
            ...
            acf_render_field_setting($field, array(
                'label' => 'SVG Icon Pack',
                'instructions' => __('Select an SVG file from the theme folder', 'swp-acf-si'),
                'type' => 'select',
                'name' => 'svg_files',
                'choices' => $icons_list,
...
//            set_transient($cachekey, $icons, YEAR_IN_SECONDS);
        ...
        /**
         * svg_files_as_choices()
         *
         * This function retrieves all SVG files in the /svg directory and adds them as choices to the given field.
         *
         * @param array $field The field array holding all the field options
         * @return array $field The updated field array with SVG files as choices
         */
        function svg_files_as_choices($field)
        {
